...
class OnnxOperatorBuilder:
    ...
    def add_node(
        ...
        **attrs,
        ...
        self._container.add_node(
            ...
            op_domain,
            op_version,
            name=self._scope.get_unique_operator_name(name),
            **attrs,
        )
    ...
    def crop_height_width(
        ...
        return self.apply_op(
            onnx_ops.apply_crop_height_width,
            inputs,
            name,
            outputs,
